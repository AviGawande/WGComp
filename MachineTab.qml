...
Item {
    ...
    height: isOpen ? (37 + 450) : 37
    // Properties
    property int machineIndex: 0
    property bool isOpen: false
    property string machineName: "Machine X"
    property string currentStepName: "A"
    property int completedSubSteps: 0
    property int maxSubSteps: 4
    property bool isComplete: false
    property bool isAutoRunning: false
    property int currentMainStep: 0
    property var subStepsCompleted: [false, false, false, false, false]
    ...
    // NEW: Property to pass to MainProgressBar
    property bool mainStepClickable: true
    ...
    // NEW: Signal to propagate the MainProgressBar click to MachineComp
    signal mainStepClicked(int mainStepIndex)

    implicitHeight: machineTab.height + (isOpen ? (contentContainer.implicitHeight + contentContainer.anchors.topMargin) : 0)
    ...
    Rectangle {
        ...
        MouseArea {
            anchors.fill: parent
            onClicked: machineTabRoot.toggleOpen()
        }
    }
    ...
    Rectangle {
        ...
        Column {
            ...
            //     height: 40
            //     currentStep: currentMainStep
            //     isComplete: machineTabRoot.isComplete
            // }
            ...
            MainProgressBar {
                width: parent.width
                height: 50
                currentStep: machineTabRoot.currentMainStep
                isComplete: machineTabRoot.isComplete
                // NEW: Pass the mainStepClickable property
                currentStepClickable: machineTabRoot.mainStepClickable
                // NEW: Connect the mainStepClicked signal
                onMainStepClicked: machineTabRoot.mainStepClicked(index) // Propagate the signal
            }
            ...
            //     width: parent.width
            //     height: 40
            //     subStepsCompleted: machineTabRoot.subStepsCompleted
            //     maxSubSteps: machineTabRoot.maxSubSteps
            //     isAutoRunning: machineTabRoot.isAutoRunning
            //     onSubStepClicked: {
            //         if (!isComplete && !isAutoRunning) {
            //             // Update status before toggling the step
            //             updateStatusFromSubStep(index, !subStepsCompleted[index]);
            ...
            SubProgressBar {
                ...
                subStepsCompleted: machineTabRoot.subStepsCompleted
                maxSubSteps: machineTabRoot.maxSubSteps
                isAutoRunning: machineTabRoot.isAutoRunning // Pass auto-running state
                // REMOVED: onSubStepClicked - no longer directly clickable
            }
            ...
            ParameterSection {
                ...
                anchors.topMargin: 10
                height: 60
                parameters: machineTabRoot.parameters
                onParameterClicked: {
                    parameterToggled(index)
                }
            }
